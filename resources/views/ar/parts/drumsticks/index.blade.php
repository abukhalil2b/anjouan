...
<div class="content">
	<div class="right">
		<div class="title">
			<h2>سيقان الدجاج مجمد

			</h2>
			<span>٥٠٠جرام</span>
		</div>
		<div class="add">
			<span class="quantity-title">كمية سيقان الدجاج مجمد <span class="txt-red-dark"> ٥٠٠ جرام</span></span>
			<div class="input">
			...
			<span class="price-text"><span>١٫٠٠٠</span> ريال عماني </span>
	...
	<div class="left">
		<div class="select-list">
			<div class="select1 selects">
				<img id="select1" src="{{asset('img/parts/drumsticks/سيقان الدجاج.png')}}" alt="">
			</div>
			<div class="select2 selects">
				<img id="select2" src="{{asset('img/parts/drumsticks/سيقان الدجاج بيانات.png')}}" alt="">
			</div>
			<div class="select3 selects">
				<img id="select3" src="{{asset('img/parts/drumsticks/اسيقان دجاج مجمد كرتون.png')}}" alt="">
			</div>
		...
		<div class="product">
			<div class="product-img">
				<img id="productImg" src="{{asset('img/parts/drumsticks/سيقان الدجاج.png')}}" alt="">
			</div>
			<div class="preserve">
